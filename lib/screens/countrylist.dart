import 'package:covid19/screens/searchCountry.dart';
...
class CountryList extends StatelessWidget {
  ...
  Widget _buildInnerTopWidget(
      String country, String todayCases, String deaths, String todayDeaths, String recovered, String critical, String cpm
      ){
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(country, style: TextStyle(fontSize: 20.0),),
          ...
          Row(
            ...
            children: <Widget>[
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("Today Cases: $todayCases", style: TextStyle(fontSize: 18.0),),
                  Text("Deaths: $deaths", style: TextStyle(fontSize: 18.0),),
                  Text("Cases/Million: $cpm", style: TextStyle(fontSize: 18.0),),
                ],
              ),
              SizedBox(width: 10.0,),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("Recovered: $recovered", style: TextStyle(fontSize: 18.0),),
                  Text("Today Deaths: $todayDeaths", style: TextStyle(fontSize: 18.0),),
                  Text("Critical: $critical", style: TextStyle(fontSize: 18.0),),
                ],
              ),
            ],
          ),
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: SimpleFoldingCell(
                  ...
                  innerBottomWidget: _buildInnerBottomWidget(results[index]['cases'].toString()),
